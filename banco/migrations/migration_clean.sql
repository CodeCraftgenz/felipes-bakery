...
ALTER TABLE `stock` ADD CONSTRAINT `stock_product_id_products_id_fk` FOREIGN KEY (`product_id`) REFERENCES `products`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `stock_movements` ADD CONSTRAINT `stock_movements_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE no action ON UPDATE no action;
ALTER TABLE `coupon_uses` ADD CONSTRAINT `coupon_uses_coupon_id_coupons_id_fk` FOREIGN KEY (`coupon_id`) REFERENCES `coupons`(`id`) ON DELETE no action ON UPDATE no action;
ALTER TABLE `coupon_uses` ADD CONSTRAINT `coupon_uses_customer_id_customers_id_fk` FOREIGN KEY (`customer_id`) REFERENCES `customers`(`id`) ON DELETE no action ON UPDATE no action;
ALTER TABLE `coupon_uses` ADD CONSTRAINT `coupon_uses_order_id_orders_id_fk` FOREIGN KEY (`order_id`) REFERENCES `orders`(`id`) ON DELETE no action ON UPDATE no action;
...
ALTER TABLE `order_status_history` ADD CONSTRAINT `order_status_history_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE no action ON UPDATE no action;
...
ALTER TABLE `analytics_events` ADD CONSTRAINT `analytics_events_session_id_analytics_sessions_id_fk` FOREIGN KEY (`session_id`) REFERENCES `analytics_sessions`(`id`) ON DELETE no action ON UPDATE no action;
ALTER TABLE `analytics_sessions` ADD CONSTRAINT `analytics_sessions_customer_id_customers_id_fk` FOREIGN KEY (`customer_id`) REFERENCES `customers`(`id`) ON DELETE no action ON UPDATE no action;
ALTER TABLE `analytics_page_views` ADD CONSTRAINT `analytics_page_views_session_id_analytics_sessions_id_fk` FOREIGN KEY (`session_id`) REFERENCES `analytics_sessions`(`id`) ON DELETE no action ON UPDATE no action;
ALTER TABLE `analytics_page_views` ADD CONSTRAINT `analytics_page_views_product_id_products_id_fk` FOREIGN KEY (`product_id`) REFERENCES `products`(`id`) ON DELETE no action ON UPDATE no action;
ALTER TABLE `pages_content` ADD CONSTRAINT `pages_content_updated_by_users_id_fk` FOREIGN KEY (`updated_by`) REFERENCES `users`(`id`) ON DELETE no action ON UPDATE no action;
...
CREATE INDEX `payments_provider_id_idx` ON `payments` (`provider_payment_id`);
CREATE INDEX `payments_status_idx` ON `payments` (`status`);
CREATE INDEX `users_email_idx` ON `users` (`email`);
CREATE INDEX `users_role_idx` ON `users` (`role`);
CREATE INDEX `users_is_active_idx` ON `users` (`is_active`);
CREATE INDEX `customers_google_id_idx` ON `customers` (`google_id`);
CREATE INDEX `customers_is_active_idx` ON `customers` (`is_active`);
CREATE INDEX `customers_deleted_at_idx` ON `customers` (`deleted_at`);
CREATE INDEX `customer_addresses_default_idx` ON `customer_addresses` (`customer_id`,`is_default`);
CREATE INDEX `categories_is_active_idx` ON `categories` (`is_active`);
CREATE INDEX `categories_display_order_idx` ON `categories` (`display_order`);
CREATE INDEX `categories_deleted_at_idx` ON `categories` (`deleted_at`);
CREATE INDEX `product_images_product_id_idx` ON `product_images` (`product_id`);
CREATE INDEX `product_images_order_idx` ON `product_images` (`product_id`,`display_order`);
CREATE INDEX `products_catalog_idx` ON `products` (`category_id`,`is_active`,`status`);
...
CREATE INDEX `coupons_validity_idx` ON `coupons` (`is_active`,`valid_from`,`valid_until`);
CREATE INDEX `coupon_uses_coupon_customer_idx` ON `coupon_uses` (`coupon_id`,`customer_id`);
CREATE INDEX `coupon_uses_coupon_id_idx` ON `coupon_uses` (`coupon_id`);
CREATE INDEX `coupon_uses_order_id_idx` ON `coupon_uses` (`order_id`);
...
CREATE INDEX `orders_status_date_idx` ON `orders` (`status`,`created_at`);
CREATE INDEX `orders_payment_status_idx` ON `orders` (`payment_status`);
CREATE INDEX `orders_created_at_idx` ON `orders` (`created_at`);
CREATE INDEX `orders_delivery_date_idx` ON `orders` (`delivery_date`);
CREATE INDEX `analytics_events_session_type_idx` ON `analytics_events` (`session_id`,`event_type`);
CREATE INDEX `analytics_events_type_idx` ON `analytics_events` (`event_type`);
CREATE INDEX `analytics_events_created_at_idx` ON `analytics_events` (`created_at`);
CREATE INDEX `analytics_sessions_sid_idx` ON `analytics_sessions` (`session_id`);
...
CREATE INDEX `analytics_sessions_device_idx` ON `analytics_sessions` (`device_type`);
CREATE INDEX `analytics_pv_product_date_idx` ON `analytics_page_views` (`product_id`,`created_at`);
CREATE INDEX `analytics_pv_session_idx` ON `analytics_page_views` (`session_id`);
CREATE INDEX `analytics_pv_created_at_idx` ON `analytics_page_views` (`created_at`);
CREATE INDEX `banners_is_active_idx` ON `banners` (`is_active`);
CREATE INDEX `banners_display_order_idx` ON `banners` (`display_order`);
CREATE INDEX `banners_validity_idx` ON `banners` (`is_active`,`valid_from`,`valid_until`);
CREATE INDEX `audit_logs_user_date_idx` ON `audit_logs` (`user_id`,`created_at`);
